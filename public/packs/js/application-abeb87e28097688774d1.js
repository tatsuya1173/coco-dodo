...
__webpack_require__(/*! ./preview */ "./app/javascript/packs/preview.js");

__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");

__webpack_require__(/*! cocoon */ "./node_modules/cocoon/app/assets/javascripts/cocoon.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
if (document.URL.match(/new/) || document.URL.match(/edit/) || document.URL.match(/recipes/)) {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var createImageHTML = function createImageHTML(blob) {
      ...
      imageElement.id = "currentThumb"; // 表示する画像を生成

      var blobImage = document.createElement('img');
      blobImage.setAttribute('src', blob);
      blobImage.width = 280; // 生成したHTMLの要素をブラウザに表示させる
    ...
    document.getElementById('message_image').addEventListener('change', function (e) {
      ...
      var imageContent = document.querySelector('#currentThumb');
...
/******/ });
//# sourceMappingURL=application-abeb87e28097688774d1.js.map